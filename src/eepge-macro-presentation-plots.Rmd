...
ewma_rets_df <- ewma_outputs$returns
...
ewma_stats <- list(mean=mean(ewma_portfolio_rets_df$portfolio) * 252 * 100,
                   vol=sd(ewma_portfolio_rets_df$portfolio) * sqrt(252) * 100,
